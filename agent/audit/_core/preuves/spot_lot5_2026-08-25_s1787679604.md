...
## - [ ] apps/backend/app/services/agent_fiche.py:54
```
...
## - [ ] apps/backend/app/services/agent_workspace.py:29
```
...
## - [ ] apps/backend/app/services/agent_definitions.py:72
```
...
## - [ ] apps/backend/app/services/agent_providers.py:52
```
...
## - [ ] apps/backend/app/services/agent_fiche.py:62
```
...
## - [ ] apps/backend/app/services/agent_discovery.py:25
```
