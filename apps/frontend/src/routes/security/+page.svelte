...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
  ...
  <p class="text-xl text-slate-600 mb-12">
    Filum est conçu pour que l'identité des créateur·ice·s et l'authenticité de leurs publications
    soient <strong>vérifiables</strong> par n'importe qui. Voici comment.
  </p>
