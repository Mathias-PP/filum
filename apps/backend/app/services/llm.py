...
_EXCERPT_SYSTEM_PROMPT = (
    ...
    "2. Propose autant de passages que le texte en contient réellement de "
    "citables, sans quota. Un document dont un seul passage porte une "
    "affirmation n'en rend qu'un ; un document dense en rend beaucoup. Ne "
    "complète jamais pour atteindre un nombre, et ne t'arrête jamais parce "
    "que tu en as déjà proposé plusieurs.\n"
    ...
    "4. Vise 15 à 80 mots pour une affirmation ou une donnée située, "
    "jusqu'à 160 mots pour un raisonnement ou une nuance argumentée. En "
    "dessous de 15 mots tu élargis, faute de pouvoir joindre une mise en "
    "situation ici. Coupe entre deux phrases, jamais au milieu de l'une.\n"
