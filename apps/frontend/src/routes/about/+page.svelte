...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
  ...
  <section class="prose prose-slate dark:prose-invert max-w-none">
    ...
    <p class="text-ink-secondary leading-relaxed">
      Le nom « Philum » s'inspire du <em>phylum</em> biologique : la branche de l'arbre du vivant
      qui regroupe les espèces par parenté évolutive. Comme un phylum, une fiche Philum dessine un
      arbre de filiation : chaque affirmation reliée à ses sources, chaque source à ses origines.
      Le nom évoque aussi le fil : celui d'Ariane, celui d'une argumentation qui tisse une
