...
Ce fichier est lu automatiquement au démarrage de chaque session. **Il route, il ne contient pas.** Chaque question ci-dessous pointe vers le fichier autoritaire.
