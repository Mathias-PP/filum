...
<svelte:head>
  <title>Philum | Vous allez adorer partager vos références</title>
  <meta
    name="description"
    content="Philum prend l’URL de votre contenu, en extrait les références, retrouve les passages que vous citez dans les pages d’origine, et publie tout ça en une fiche que votre audience peut parcourir."
  />
</svelte:head>
