...
class CardService:
    ...
    async def create_card(self, user_id: UUID, card_data: CardCreate) -> BiblioCard:
        card = BiblioCard(
            ...
            card_kind=card_data.card_kind.value,
            platform=card_data.platform.value if card_data.platform else None,
            content_type=card_data.content_type.value if card_data.content_type else None,
