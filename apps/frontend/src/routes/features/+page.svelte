...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
  ...
  <div class="grid md:grid-cols-2 gap-6 mb-16">
    <div class="bg-white border border-slate-200 rounded-xl p-6">
      ...
      <p class="text-slate-600 text-sm">
        Visualisez vos sources sous forme de graphe dynamique. Chaque nœud représente une source, les
        pivots sont mis en avant. Exploration intuitive : cliquez, glissez, zoomez.
      </p>
    </div>

    <div class="bg-white border border-slate-200 rounded-xl p-6">
      <div class="w-10 h-10 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center mb-3">
        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
      </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6">
      <div class="w-10 h-10 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center mb-3">
        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
      </div>
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Archivage automatique</h3>
      <p class="text-slate-600 text-sm">
        Chaque source est automatiquement archivée via la Wayback Machine. Même si la page originale
        disparaît, sa copie reste accessible.
      </p>
    </div>

    <div class="bg-white border border-slate-200 rounded-xl p-6">
      <div class="w-10 h-10 rounded-lg bg-amber-100 text-amber-600 flex items-center justify-center mb-3">
        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
      </div>
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Extraction automatique</h3>
      <p class="text-slate-600 text-sm">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6">
      <div class="w-10 h-10 rounded-lg bg-rose-100 text-rose-600 flex items-center justify-center mb-3">
        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
      </div>
  ...
  <h2 id="a-venir" class="text-2xl font-semibold text-slate-900 mb-6">En préparation</h2>
  <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200 border-dashed">
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Copier-coller de bibliographie</h3>
      <p class="text-slate-600 text-sm">
    ...
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200 border-dashed">
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Citations intelligentes</h3>
      <p class="text-slate-600 text-sm">
    ...
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200 border-dashed">
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Import Zotero / Obsidian</h3>
      <p class="text-slate-600 text-sm">
    ...
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200 border-dashed">
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Bibliographies collaboratives</h3>
      <p class="text-slate-600 text-sm">
    ...
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200 border-dashed">
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Export PDF / CSV / Excel</h3>
      <p class="text-slate-600 text-sm">
        Exportez vos fiches dans tous les formats : PDF, CSV, Excel, JSON, BibTeX, CSL-JSON.
      </p>
    </div>
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200 border-dashed">
      <h3 class="text-lg font-semibold text-slate-900 mb-2">Extension navigateur</h3>
      <p class="text-slate-600 text-sm">
    ...
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200 border-dashed">
      <h3 class="text-lg font-semibold text-slate-900 mb-2">API publique</h3>
      <p class="text-slate-600 text-sm">
