...
| Fiche | Contenu | LOC | Fichier |
|---|---|---|---|
| [01-providers.md](01-providers.md) | CRUD BYOK, chiffrement, cache modèles, test clé, souveraineté | 608 | `apps/backend/app/services/agent_providers.py` |
| [02-gratuit.md](02-gratuit.md) | Lanes Z.ai, rotation, cooldown, consentement versionné, catalogue modèles | 420 | `apps/backend/app/services/agent_gratuit.py` |
| [03-workspace.md](03-workspace.md) | Filesystem logique, normalisation chemins, seed, frontmatter, meta | 320 | `apps/backend/app/services/agent_workspace.py` |
| [04-definitions.md](04-definitions.md) | Agents nommés YAML, validation, `tools_absents`, tri builtin | 192 | `apps/backend/app/services/agent_definitions.py` |
| [05-fiche.md](05-fiche.md) | Orchestrateur 7 étages ICM, reprise `depuis`, compte rendu séquentiel | 211 | `apps/backend/app/services/agent_fiche.py` |
| [06-discovery.md](06-discovery.md) | Clé serveur DeepSeek, quota découverte, provider transient | 142 | `apps/backend/app/services/agent_discovery.py` |
