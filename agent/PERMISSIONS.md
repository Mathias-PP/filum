...
_Cette matrice est référencée par `agent/README.md` et utilisée par l'agent à chaque action. Si une règle te paraît trop restrictive ou pas assez, ouvre une PR `docs:` pour la modifier._
