...
<div bind:this={container} class="relative w-full h-full bg-slate-950">
  ...
  {:else}
    <div
      class="glass glass-panel absolute bottom-3 left-3 rounded-md px-2.5 py-1.5 text-xs text-slate-300"
    >
    ...
    <button
      onclick={resetView}
      class="glass glass-panel absolute top-3 right-3 h-8 w-8 rounded-md text-slate-300 hover:text-white flex items-center justify-center transition-colors"
