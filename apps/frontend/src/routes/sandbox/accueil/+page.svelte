<script lang="ts">
  /**
   * Atelier : page d'accueil v2, mise de côté.
   *
   * Cette version a été livrée en accueil le 11 août puis retirée : l'accueil
   * de production est revenu à sa forme précédente. Elle reste ici, complète,
   * pour servir de base si le sujet est repris.
   *
