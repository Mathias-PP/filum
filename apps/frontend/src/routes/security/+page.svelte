...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
  ...
  <section class="prose prose-slate max-w-none">
    <h2 class="text-2xl font-semibold text-slate-900 mt-12 mb-4">Ce qui est signé</h2>
    ...
    <ol class="list-decimal pl-6 space-y-4 text-slate-600">
      <li>
        <strong class="text-slate-900">Canonicalisation</strong> : le triplet à signer (votre id, URL
      ...
      <li>
        <strong class="text-slate-900">Signature</strong> : l'empreinte est signée avec votre clé privée
        Ed25519, produisant une signature de 64 octets. La clé privée est chiffrée sur le serveur avec
        AES-256-GCM.
      </li>
      <li>
        <strong class="text-slate-900">Stockage</strong> : la signature et l'empreinte sont stockées avec
        l'attestation de contenu.
      </li>
    </ol>
