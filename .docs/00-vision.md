...
> Vision du projet condensée en quelques minutes de lecture. Pour la version complète, voir le manifeste fondateur dans `MANIFESTE.md`.
...
L'IA générative démultiplie la production de contenu et brouille les pistes de l'authenticité. Trois constats convergents :

1. Les **créateurs sérieux** qui sourcent leur travail le font dans le silence : leurs sources finissent dans un bloc de texte en bas de description, illisible et ignoré. Le travail invisible n'est jamais récompensé.

2. Les **lecteurs et auditeurs** n'ont aucun moyen rapide de juger la solidité d'un contenu autrement qu'à la réputation de son auteur. Pas de signal objectif intermédiaire.
...
5. **Gratuit pour les créateurs jusqu'à un seuil généreux.** La pratique vertueuse (sourcer) reste toujours gratuite.
6. **Lecture native par les humains et par les IA.** URLs stables, JSON-LD, Schema.org.
7. **Lineage à la demande, jamais imposé.** Pas de scrap automatique, déclaration volontaire.
...
## Trois angles d'effet wow pour le MVP

Le MVP active simultanément trois moments wow :

1. **La carte interactive des sources.** Le créateur découvre que sa bibliographie devient visible et belle. Le lecteur découvre la structure intellectuelle d'un contenu en un coup d'œil. Inspiration : Pappers, Obsidian, Are.na.
...
## Les cibles, par cercles

**Cercle 1 — adoption (les créateurs sourceurs)**
Vulgarisateurs scientifiques (cible primaire MVP), journalistes indépendants, essayistes, chercheurs qui partagent leurs travaux, fact-checkers.

**Cercle 2 — monétisation (les bénéficiaires économiques)**
Moteurs de recherche IA, plateformes sociales sous obligations DSA, médias établis, fact-checkers professionnels, assureurs, gouvernements.
